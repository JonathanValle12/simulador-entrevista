      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4 sm:h-16">
        ...
        <div className="inline-flex items-center gap-2">
          <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-blue-600/10">
            <svg className="h-5 w-5 text-blue-600" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <span className="text-sm font-semibold text-gray-900 sm:text-base">Configurar Entrevista</span>
        </div>
      </div>
    </header>
  );
