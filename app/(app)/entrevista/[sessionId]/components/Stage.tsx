...
export default function Stage() {
    return (
        <div className="relative min-h-[360px] w-full rounded-xl bg-slate-800 mt-4">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-3">
                <Video className="h-10 w-10 text-slate-400" aria-hidden />
                <p className="text-sm text-slate-400">Simulación de Videollamada</p>
            </div>
        </div>
    )
}