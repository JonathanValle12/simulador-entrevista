...
export default function Header() {
    return (
        <header className="sticky top-0 z-40 w-full bg-white/50 backdrop-blur border-b border-slate-200">
            <div className="mx-auto w-full max-w-7xl px-2 lg:px-6 py-3.5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1.5 text-slate-700">
                        ...
                        <span className="text-sm font-medium leading-none tabular-nums tracking-[0.2em]">
                            29:31
                        </span>
                    </div>
